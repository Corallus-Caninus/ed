...
optimizer = FBFGS(model.parameters(), lr=1., history_size=9, tolerance_change=16, max_iter=10, max_eval=1, line_search_fn="strong_wolfe", y_norm=1.5, norm=1.2, radius_y=5e4, radius_ball=10, radius_ball_s=1, radius_s=1e5, c1=1e-7, c2=0.1, direction_device="cpu", optimizer_device=optimizer_device, bracket_shift=1/3, bracket_shove=1/3, capture_max_step=10, capture_min_step=0.01, rho_rewind=1, orthogonality=10, max_ls=1, norm_group_s=5, norm_group_y=0.2, prefetch_buffer=50e6)
