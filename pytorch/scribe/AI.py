...
optimizer = FBFGS(model.parameters(), lr=1., history_size=10., tolerance_change=16, max_iter=10, max_eval=100, line_search_fn="strong_wolfe", clop=5e-8, c1=3e-4, c2=0.9,direction_device="cuda:1", bracket_shift = 1/3, bracket_shove = 1/3)
