...
optimizer = LBFGS(model.parameters(), lr=1., history_size=4.4, tolerance_change=16, max_iter=10, max_eval=100, line_search_fn="strong_wolfe",gradient_clop=5e-6, direction_clop=1e-6, c1=1e-4, c2=0.9)
