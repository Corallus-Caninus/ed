...
optimizer = LBFGS(model.parameters(), lr=1., history_size=4., tolerance_change=16, max_iter=10, max_eval=100, line_search_fn="strong_wolfe",gradient_clop=1e-11, direction_clop=1e-9, c1=3e-4, c2=0.9,direction_device="cpu", bracket_shift = 1/3, bracket_shove = 1/3)
