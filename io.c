...
bool
display_lines(int from, const int to, const int gflags)
{
...
static bool
trailing_escape(const char *const s, int len)
{
...
bool
get_extended_line(const char **const ibufpp, int *const lenp,
...
static const char *
read_stream_line(FILE *const fp, int *const sizep,
...
static long
read_stream(FILE *const fp, const int addr)
{
...
int
read_file(const char *const filename, const int addr)
{
  FILE *fp;
  long size;
  int ret;
...
static long
write_stream(FILE *const fp, int from, const int to)
{
...
int
write_file(const char *const filename, const char *const mode,
